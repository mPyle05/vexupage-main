...
// /public/images and it renders; leave it null and the page falls back to
// a dashed placeholder automatically — nothing else needs to change.
export const IMAGES = {
  logo: "/vexupage/images/UC_Red.png", // used in the nav (on light background)
  logoAlt: "/vexupage/images/UC_White.png", // used in the footer (on dark background)
  hero: null, // e.g. "/images/hero.jpg" — team or workshop photo
  outreach: null, // e.g. "/images/outreach.jpg" — outreach/volunteering photo
};

// Single competing team. If you ever field a second team, turn this back
// into an array and update app/page.js + app/team/page.js to map over it.
export const TEAM = {
  number: "C1ncy",
  eventsUrl: "https://www.robotevents.com/teams/VURC/C1ncy",
};

// "By the numbers" — kept to facts that don't need updating as the season
// progresses (nothing here should need touching until something structural
...
// Shown as a compact line under the discipline grid — swap tools as your
// actual stack changes. Low-maintenance since a team's core toolchain
// rarely changes season to season.
export const STACK = [
  { category: "Mechanical", tools: ["Onshape", "VEX V5", "CNC", "3D Printing"] },
  { category: "Electrical", tools: ["V5 Electronics", "Sensors", "Custom Wiring"] },
  { category: "Software", tools: ["C++", "PROS / VEXcode", "Git"] },
];
...
export const SOCIALS = [
  ...
  { label: "GitHub", type: "github", href: "https://github.com/" },
  { label: "YouTube", type: "youtube", href: "https://youtube.com/" },
];

export const CONTACT = {
  email: "c1ncy@uc.edu",
  meetingInfo: "Meeting time TBD — Engineering Research Center",
...
// Shows up in the footer. Replace with your name (and optionally a link).
export const SITE_CREDIT = {
  name: "Your Name",
  href: "", // e.g. "https://github.com/yourusername" — leave blank to hide the link
};
