...
export const IMAGES = {
  logo: "/vexupage-main/images/UC_Red.png", // used in the nav (on light background)
  logoAlt: "/vexupage-main/images/UC_White.png", // used in the footer (on dark background)
...
export const SITE_CREDIT = {
  name: "Mason Pyle",
  href: "https://www.linkedin.com/in/mason-pyle/", // e.g. "https://github.com/yourusername" — leave blank to hide the link
};
